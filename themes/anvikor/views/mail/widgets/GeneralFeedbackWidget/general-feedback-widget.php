...
<?= CHtml::openTag('div', $this->modalHtmlOptions) ?>
    <div class="modal-wrap fl fl-jc-c fl-ai-c">
        <div class="modal-dialog fl fl-jc-c">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-bot">
                            ...
                            <div class="form-button">
                                ...
                                <?php endif ?>
                                    <button id="<?= $this->sendButtonId ?>" type="submit" class="btn btn-send">
                                        <?= $this->sendButtonText ?>
                                    </button>
                            </div>
                        </div>
                        <div class="terms_of_use">
                            * Оставляя заявку Вы соглашаетесь с
                            <a target="_blank" href="/uploads/politikaconf.rtf">Условиями обработки персональных данных</a>
