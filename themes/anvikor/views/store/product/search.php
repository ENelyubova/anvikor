...
<!-- Каталог -->
<div class="store-container store-container-catalog pt">
    <div class="content-site">
        ...
        <h1 class="heading heading-catalog heding-mobile-visible"><?= Yii::t("StoreModule.store", "Каталог товаров"); ?></h1>
        ...
        <div class="catalog-wrapper fl fl-w fl-jc-sb">
            ...
            <div class="catalog-wrapper__content">
                <h1 class="heading heading-catalog heding-mobile-hidden"><?= Yii::t("StoreModule.store", "Каталог товаров"); ?></h1>
