...
/**
   ...
   */
    ...
    /*Вид товаров*/
    $('.layout-buttons .grid').click(function() {
        $('.layout-buttons .list').removeClass('active');
        $(this).addClass('active');
        $('.product-block').removeClass('list-view').addClass('grid-view');
        return false;
    });

    $('.layout-buttons .list').click(function() {
        $('.layout-buttons .grid').removeClass('active');
        $(this).addClass('active');
        $('.product-block').removeClass('grid-view').addClass('list-view');
        return false;
    });
    ...
    $(document).delegate('a[data-jsmodal]', 'click', function (e) {
        ...
        $(modal).find('.card-content').html(content);
        $(modal).modal('show');
    ...
    /*Интерактивное фото*/
    $('.presents-btn').on("click", function(){
        var el = $(this);
    ...
    //показываем телефон при клике на скрытый
    $('.hide-phone').on('click',function(){
        $('.hide-phone').addClass('hide');
        $('.return-phone').removeClass('hide');
    });
    ...
    */
    ...
    $('.slider-product').slick({
        ...
        appendArrows: '.slider-carousel .arrows',
        infinite: false,
        autoplay: false,
        autoplaySpeed: 5000,
        focusOnSelect: false,
    ...
    /*Галерея*/
    if($('div').hasClass('gallery-carousel')){
        $('.gallery-carousel').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.gallery-block .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    if($('div').hasClass('sertificate-carousel')){
        $('.sertificate-carousel').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.sertificate-block .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
