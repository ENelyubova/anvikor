...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        <div class="row">
            ...
            <div class="col-sm-3">
                <br/>
                <?= $form->checkBoxGroup($model, 'is_slide'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
        ...
        <div class='row'>
            <div class="col-sm-7">
                <div class="preview-image-wrapper<?= !$model->getIsNewRecord() && $model->icon ? '' : ' hidden' ?>">
                    ...
                    <?=
                    CHtml::image(
                        !$model->getIsNewRecord() && $model->icon ? $model->getImageNewUrl(200, 200, true, null, 'icon') : '#',
                        $model->name,
                        [
                            'class' => 'preview-image img-thumbnail',
                ...
                <?php if (!$model->getIsNewRecord() && $model->icon): ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="delete-file2"> <?= Yii::t(
                                'YupeModule.yupe',
                                'Delete the file'
                            ) ?>
                        </label>
        ...
        <div class='row'>
            <div class="col-sm-7">
                <div class="preview-image-wrapper<?= !$model->getIsNewRecord() && $model->icon2 ? '' : ' hidden' ?>">
                    <div class="btn-group image-settings">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="collapse"
                                data-target="#image-settings"><span class="fa fa-gear"></span></button>
                        <div id="image-settings" class="dropdown-menu">
                    ...
                    <?=
                    CHtml::image(
                        !$model->getIsNewRecord() && $model->icon2 ? $model->getImageNewUrl(200, 200, true, null, 'icon2') : '#',
                        $model->name,
                        [
                            'class' => 'preview-image img-thumbnail',
                            'style' => !$model->getIsNewRecord() && $model->icon2 ? '' : 'display:none',
                        ]
                    ); ?>
                </div>

                <?php if (!$model->getIsNewRecord() && $model->icon2): ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="delete-file2"> <?= Yii::t(
                                'YupeModule.yupe',
        ...
        <div class='row'>
            <div class="col-sm-7">
                <?= (!$model->isNewRecord && $model->document) ? $model->document : ''; ?>
                <?php if (!$model->isNewRecord && $model->document): ?>
                    <div class="checkbox">
                        <label>
                ...
                <?= $form->fileFieldGroup($model, 'document'); ?>
