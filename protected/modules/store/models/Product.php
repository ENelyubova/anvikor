...
class Product extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            [
                'name, title, description, short_description, slug, price, discount_price, discount, data, status, is_special, is_slide',
                'filter',
                'filter' => 'trim',
            ],
            [
            ...
            ['name, slug', 'required'],
            [
                'status, is_special, producer_id, type_id, in_stock, category_id, is_slide',
                'numerical',
                'integerOnly' => true,
            ],
            ...
            [
                'name, title, meta_keywords, meta_title, meta_description, meta_canonical, image, icon, icon2, image_alt, image_title',
                'length',
                'max' => 250,
            ],
            ...
            ['is_special, is_slide', 'boolean'],
            ['length, height, width, weight', 'default', 'setOnEmpty' => true, 'value' => null],
            ['meta_canonical', 'url'],
            [
                'id, type_id, producer_id, sku, name, slug, price, discount_price, discount, short_description, description, data, is_special, length, height, width, weight, quantity, in_stock, status, create_time, update_time, meta_title, meta_description, meta_keywords, category_id, document, is_slide',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function relations()
    {
        return [
            ...
            'icon' => [self::HAS_MANY, 'ProductImage', 'product_id'],
            'icon2' => [self::HAS_MANY, 'ProductImage', 'product_id'],
            'variants' => [
                self::HAS_MANY,
                'ProductVariant',
                ['product_id'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_special' => Yii::t('StoreModule.store', 'В наличии'),
            ...
            'document' => Yii::t('StoreModule.store', 'Документ'),
            'icon' => Yii::t('StoreModule.store', 'Слайд 1'),
            'icon2' => Yii::t('StoreModule.store', 'Слайд 2'),
            'is_slide' => Yii::t('StoreModule.store', 'Показать в слайдере'),
        ];
    }
    ...
    public function attributeDescriptions()
    {
        return [
            ...
            'image_title' => Yii::t('StoreModule.store', 'Image title'),
            'view' => Yii::t('StoreModule.store', 'Template'),
            'icon' => Yii::t('StoreModule.store', 'Icon'),
            'icon2' => Yii::t('StoreModule.store', 'Icon'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('t.document', $this->document);
        $criteria->compare('t.is_slide', $this->is_slide);
    ...
    public function behaviors()
    {
        ...
        return [
            ...
            'fileUpload' => [
                ...
                'minSize'       => $module->minSize,
                'maxSize'       => $module->maxSize,
                'types'         => 'docx, doc, pdf, xlsx, xls',
                'uploadPath'    => $module->uploadPathPrice,
                'deleteFileKey'     => 'delete-file4'
            ],
            'sortable' => [
    ...
    {
        $module = Yii::app()->getModule('store');
        return '/uploads/'.$module->uploadPathPrice.'/'.$this->document;
    }
