    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [ // Main rules
                ...
                '/backend/<action:(AjaxUploadTinyMCE5|ElFinderConnection|AjaxFileUpload|AjaxImageUpload|AjaxImageUploadCKE|index|settings|flushDumpSettings|modulesettings|saveModulesettings|themesettings|modupdate|help|ajaxflush|transliterate)>' => '/yupe/backend/<action>',
